...
public class Etudiant {
    ...
    private void miseAJourNotes(double maths, double info, double bio) {
    	if((maths>=0 && maths<=20) && (info>=0 && info<=20) && (bio>=0 && bio<=20)) {
    		...
    		System.out.println("Une ou plusieures notes saisies ne fait/font pas partie/s de l'intervalle de définition !");
    }
    ...
    public Nationality saisieNationalite(Scanner scanner) {
    	Nationality nat;
    	System.out.println("Veuillez saisir le numéro correspondant à la nationalité");
